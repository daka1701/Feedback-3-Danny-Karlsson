...
namespace GergelySzaboCsharp
{
    class Accommodation
    {
        ...
        public Accommodation(int roomID, int hostID, string roomType, string borough,
            string neighborhood, int reviews, double overallSatisfaction, int accomodates,
            int bedrooms, int price, int minstay, double latitude, double longitude, string lastModified)
        {
            this.roomID = roomID;
            this.hostID = hostID;
